...
export default function AdminServiceTypesPage() {
  ...
  return (
    <CrudManager<ServiceType>
      title={t('admin.serviceTypes.title')}
      description={t('admin.serviceTypes.description')}
      addLabel={t('admin.serviceTypes.add')}
      columns={[
        {
          key: 'name',
      ...
      onRetry={reload}
      emptyIcon={Layers}
      emptyTitle={t('admin.empty_serviceTypes')}
      emptyDescription={t('admin.empty_serviceTypes_desc')}
      rowKey={(s) => s.id}
      ...
      formTitleAdd={t('admin.serviceTypes.add')}
      formTitleEdit={t('admin.serviceTypes.edit')}
    />
  )
}
  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      <div className="space-y-2">
        <Label htmlFor="type-name">{t('admin.form_name')}</Label>
        <Input
          id="type-name"
          value={name}
